...
public class Disc_intB {
	ArrayList<Integer[]> list;
	private final Integer[] i1 = {2,1,4,3};
	private final Integer[] i2 = {4,1,2,5};
	private final Integer[] i3 = {2,4,1,3};
	private final Integer[] i4 = {2,4,3,1};
	private final Integer[] i5 = {1,4,2,3};
	private final Integer[] i6 = {3,5,4,1};
	private final Integer[] i7 = {2,4,1,3};
	private final Integer[] i8 = {2,5,3,1};
	private final Integer[] i9 = {4,3,2,1};
	private final Integer[] i10= {1,2,3,4};
	...
	private final Integer[] i15= {2,5,1,3};
	private final Integer[] i16= {4,1,3,2};
	private final Integer[] i17= {2,3,1,4};
	private final Integer[] i18= {3,5,4,2};
	private final Integer[] i19= {1,2,3,4};
	private final Integer[] i20= {2,3,4,1};
	...
	public Integer[] getList(int b_c) {
		return list.get(b_c);
	}
